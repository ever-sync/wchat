-- Varias linhas de venda (produto + quantidade + preco opcional) via p_sale_items jsonb.
-- Mantem compatibilidade: se p_sale_items vazio/ausente, usa p_sale_product_id (1 unidade).
