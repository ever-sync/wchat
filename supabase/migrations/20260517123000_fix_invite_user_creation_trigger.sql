-- Corrige "Database error saving new user" no convite:
-- nao apagar collaborator_invites no trigger de auth (so na ativacao de senha).
...
-- Evita que falha ao criar vendedor Trendii cancele o cadastro no Auth.
