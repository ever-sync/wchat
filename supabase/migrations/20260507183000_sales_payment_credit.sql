...
create index if not exists customer_credits_tenant_sale_idx
  on public.customer_credits (tenant_id, sale_id);

alter table public.sales
  add column if not exists payment_method text;

update public.sales
  set payment_method = 'nao_informado'
  where payment_method is null;

alter table public.sales
  alter column payment_method set default 'nao_informado';
