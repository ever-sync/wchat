-- Observacoes opcionais na devolucao: returns.notes via register_sale_flow (p_return_notes, ate 2000 caracteres).

alter table public.returns
  add column if not exists notes text;

-- Demais comportamentos de register_sale_flow iguais a 20260511130000_returns_partial_quantity.sql.
