            ...
            <div className="col-lg-5">
              <div className="title-area mb-40 text-center text-lg-start">
                <h2 className="sec-title h3 text-white text-anime-style-2">
                  Eleve o atendimento comercial do seu time <img src="assets/img/icon/star6.png" alt="" />
                </h2>
                <span className="box-text wow fadeInUp text-white">Comece em minutos. Sem cartão de crédito.</span>
              </div>
